...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['excel_file'])) {
    ...
    if ($file['error'] !== UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file['tmp_name'], $uploadPath)) {
            $result = importVideos($uploadPath);
            unlink($uploadPath); // 删除临时文件
    ...
    <div class="container">
        ...
        <div class="info-box">
            ...
            <ul>
                ...
                <li>2. 使用Excel或文本编辑器打开CSV文件，按照模板格式填写数据（第一行为表头，不要修改）</li>
                <li>3. 选择填写好的CSV文件进行上传</li>
                <li>4. 系统会自动导入数据</li>
            </ul>
