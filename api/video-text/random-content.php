...
$stmt = $pdo->prepare("SELECT `material_id`, `video_url`, `thumbnail_url`,
                              `download_count`, `like_count`, `created_at`
...
// 构建完整的VideoTextMaterial数据结构
$result = [
    'material_id' => $material['material_id'],
    'video_url' => absoluteMediaUrl($material['video_url']),
    'thumbnail_url' => absoluteMediaUrl($material['thumbnail_url'] ?? null),
